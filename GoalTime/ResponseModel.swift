...
class ResponseModel: Codable {
    let responseModelGet: String
    let parameters, errors: [JSONAny]
    let results: Int
    let paging: Paging
    let response: [Response]

    enum CodingKeys: String, CodingKey {
        case responseModelGet = "get"
        case parameters, errors, results, paging, response
    }

    init(responseModelGet: String, parameters: [JSONAny], errors: [JSONAny], results: Int, paging: Paging, response: [Response]) {
        self.responseModelGet = responseModelGet
...
class Response: Codable {
    ...
    init(league: League, country: Country, seasons: [Season]) {
        self.league = league
...
class League: Codable {
    ...
    init(id: Int, name: String, type: TypeEnum, logo: String) {
        self.id = id
        self.name = name
        self.type = type
        self.logo = logo
...
class Coverage: Codable {
    ...
    init(fixtures: Fixtures, standings: Bool, players: Bool, topScorers: Bool, topAssists: Bool, topCards: Bool, injuries: Bool, predictions: Bool, odds: Bool) {
